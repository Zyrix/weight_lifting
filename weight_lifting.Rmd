---
title: "Prediction of exercise quality by machine learning"
author: "Philipp Brandl"
output: html_document
---

The goal of this project is to predict the manner in which subject did the exercise. This is the "classe" variable in the training set. After preprocessing of the data, a model is built by fitting a tree. Then cross-validation is done and the expected out of sample error is calculated.
